...
3) in the same directory, type in the terminal one of the 2 following commands:
   -> npm start [preferred]
   -> node index.js
...
|                                                                                                                                                       |
|     -> BE CAREFUL THAT from 08/05/2020 IF THE DOCUMENT IS MODIFIED BY HAND FROM 'false' TO 'true' IN MONGODB,                                         |
